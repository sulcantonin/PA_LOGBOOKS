...
class FixedTimeWeightedVectorStoreRetriever(BaseRetriever):
    ...
    """ Field of document.metadata where to look for timestamp """
    ...
    def _document_get_date(self, field: str, document: Document) -> datetime.datetime:
        ...
        if field in document.metadata:
            ...
            raise Exception(f'Missing field {field} in document metadata {document.metadata}')
    ...
    def _get_combined_score(
        ...
        hours_passed = _get_hours_passed(
            current_time,
            self._document_get_date(self.timestamp_field, document),
        )
